    ...
    <div class="container">
      <main>
        <div class="content fade-in">
          ...
          <p class="fade-in">The future of educational assessment</p>
        </div>
        <h1 class="fade-in">
          Smarter quizzes for <span class="gradient-text">modern education</span>
        </h1>
        <p class="system-description fade-in">
        ...
        <div class="buttons fade-in">
          <button class="btn btn-green fade-in">Start free trial</button>
          <button class="btn btn-gray fade-in">See how it works</button>
        </div>
      </main>
    </div>
  `,
